...
```{r }
us_set = USPersonalExpenditure
us_set

dataframe_us <- as.data.frame(us_set)  #convert data into data frame to see visual columns clearly
dataframe_us 
```
...
steady <- summarise_at(dataframe_us, c("1940","1945", "1955", "1960"),funs(mean,sd), na.rm = T)
steady
...
dataframe_us %>% mutate(Average_values = rowMeans(dataframe_us))
```
